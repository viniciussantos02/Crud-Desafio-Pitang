...
<div class="d-flex justify-content-center">
	<form action="usuario" method="post" class="mt-5 p-4 border" style="width: 30rem;">
	<input type="hidden" name="option" value="cadastrar"></input>
	  <div class="form-group">
	    <label for="inputAddress">Nome</label>
	    <input type="text" class="form-control" name="nome" id="inputName" placeholder="Seu nome aqui...">
	  </div>
	  <div class="form-row">
	  ...
	  <div class="form-row">
	    <div class="form-group col-md-2">
	      ...
	      <input type="text" class="form-control" name="ddd" id="inputDdd" placeholder="Ex. 81">
	    </div>
	    <div class="form-group col-md-6">
	      <label for="inputEstado">Numero</label>
	      <input type="text" class="form-control" name="numero" id="inputNumber" placeholder="99999-9999">
	    </div>
